from .event_views import event_detail , EventCreate , EventEdit , EventDelete ,event_list_calender, calendar
from .usercalls_views import signup, create_room, join_room, call_room, list_rooms, deactivate_room
from .pages_views import home ,sign_to_text_view
from .lessons_views import lessons_by_language, lesson_detail, complete_lesson , edit_comment , delete_comment 
from .games_views import game_home, get_random_word, check_guess, show_answer, reset_score, leaderboard, name_game_view ,games
