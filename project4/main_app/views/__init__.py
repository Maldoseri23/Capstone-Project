from .event_views import event_detail , EventCreate , EventEdit , EventDelete ,event_list_calender
from .usercalls_views import signup, create_room, join_room, call_room, list_rooms, deactivate_room
from .pages_views import home , calendar ,sign_to_text_view, Games
